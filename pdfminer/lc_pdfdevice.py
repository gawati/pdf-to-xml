#!/usr/bin/env python
from lc_utils import mult_matrix, translate_matrix
from lc_utils import enc, bbox2str, isnumber
...
class PDFTextDevice(PDFDevice):
    ...
    def render_string(self, textstate, seq):
        ...
        if font.is_vertical():
            textstate.linematrix = self.render_string_vertical(
                seq, matrix, textstate.linematrix, font, fontsize,fontcolor,
    ...
    def render_string_horizontal(self, seq, matrix, (x, y),
                                 font, fontsize, fontcolor, scaling, charspace, wordspace, rise, dxscale):
        needcharspace = False
        for obj in seq:
            if isnumber(obj):
                x -= obj*dxscale
                ...
                for cid in font.decode(obj):
                    ...
                    x += self.render_char(translate_matrix(matrix, (x, y)),
                                          font, fontsize, fontcolor, scaling, rise, cid)
